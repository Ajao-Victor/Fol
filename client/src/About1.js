    ...
    return(
        <div className="grandParent1"> 
            <div className="childAbout1">
                <div style={{width: "80%"}}><h1>Website Development as a Career</h1></div>
                <div className="text">
                Web development is a dynamic and rewarding career that blends creativity with problem-solving. It involves building websites and web applications using technologies like HTML, CSS, JavaScript, and frameworks such as React, Angular, or Vue.js. Back-end development with Node.js, Express, and databases like PostgreSQL adds functionality to web apps.

As a web developer, you can work freelance, in startups, or for major tech companies, with opportunities to specialize in front-end, back-end, or full-stack development. The demand for skilled developers continues to grow, offering flexibility, remote work, and high earning potential. With continuous learning and hands-on practice, anyone can master web development and build scalable, interactive, and innovative digital experiences. 
                </div>
            </div>
